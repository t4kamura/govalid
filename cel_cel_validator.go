...
var (
	...
	ErrPositiveValueCELValidation = errors.New("field PositiveValue failed CEL validation: value > 0 ? value : 0")
	...
	// ErrBirthDateCELValidation is the error returned when the CEL expression evaluation fails.
	ErrBirthDateCELValidation = errors.New("field BirthDate failed CEL validation: value > timestamp('2000-01-01T00:00:00Z')")
...
func ValidateCEL(t *CEL) error {
	...
	if !(t.BirthDate > func() time.Time { t, _ := time.Parse(time.RFC3339, "2000-01-01T00:00:00Z"); return t }()) {
		return ErrBirthDateCELValidation
	}
