...
type ValidatorFactory func(pass *codegen.Pass, field *ast.Field, expressions map[string]string, structName string, ruleName string, parentPath string) validator.Validator
